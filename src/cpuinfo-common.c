...
static const cpuinfo_feature_string_t x86_feature_strings[] = {
  ...
  DEFINE_(X86_MMX_PLUS,	"mmxext",		"MMX+ Technology (AMD or Cyrix)"					),
  DEFINE_(X86_3DNOW,	"3dnow",	"3DNow! Technology"									),
  DEFINE_(X86_3DNOW_PLUS, "3dnowext",	"Enhanced 3DNow! Technology"						),
  ...
  DEFINE_(X86_CMPXCHG16B,	"cx16",	"CMPCXHG16B Instruction"),
  DEFINE_(X86_XTPRUC,		"xtpr",	"xTPR Update Conrol"),
