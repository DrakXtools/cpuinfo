...
static const cpuinfo_feature_string_t x86_feature_strings[] = {
  ...
  DEFINE_(X86_PSE_36,		"pse-36",	"36-Bit Page Size Extension"),
  ...
  DEFINE_(X86_MMX_PLUS,	"mmx+",		"MMX+ Technology (AMD or Cyrix)"					),
  DEFINE_(X86_3DNOW,	"3dnow",	"3DNow! Technology"									),
  DEFINE_(X86_3DNOW_PLUS, "3dnow+",	"Enhanced 3DNow! Technology"						),
