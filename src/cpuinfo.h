...
typedef enum {
  ...
  CPUINFO_FEATURE_ARM_BEGIN,
  CPUINFO_FEATURE_ARM_SWP = CPUINFO_FEATURE_ARM_BEGIN,
  ...
  CPUINFO_FEATURE_AARCH64_BEGIN = (CPUINFO_FEATURE_AARCH64|(CPUINFO_FEATURE_ARM_MAX&CPUINFO_FEATURE_MASK)),
  CPUINFO_FEATURE_AARCH64_FP = CPUINFO_FEATURE_AARCH64_BEGIN,
  ...
  CPUINFO_FEATURE_ARM_CRYPTO_BEGIN = (CPUINFO_FEATURE_ARM_CRYPTO|(CPUINFO_FEATURE_AARCH64_MAX&CPUINFO_FEATURE_MASK)),
  CPUINFO_FEATURE_ARM_CRYPTO_AES = CPUINFO_FEATURE_ARM_CRYPTO_BEGIN,
