...
typedef enum {
  ...
  CPUINFO_FEATURE_ARM_CRYPTO,
  CPUINFO_FEATURE_ARM_CRYPTO_AES,
  ...
  CPUINFO_FEATURE_AARCH64 = CPUINFO_CLASS('z'),
  CPUINFO_FEATURE_AARCH64_EVTSTRM =  CPUINFO_FEATURE_ARM_EVTSTRM,
  CPUINFO_FEATURE_AARCH64_CRYPTO_AES = CPUINFO_FEATURE_ARM_CRYPTO_AES,
  CPUINFO_FEATURE_AARCH64_CRYPTO_PMULL = CPUINFO_FEATURE_ARM_CRYPTO_PMULL ,
  CPUINFO_FEATURE_AARCH64_CRYPTO_SHA1 = CPUINFO_FEATURE_ARM_CRYPTO_SHA1,
  CPUINFO_FEATURE_AARCH64_CRYPTO_SHA2 = CPUINFO_FEATURE_ARM_CRYPTO_SHA2,
  CPUINFO_FEATURE_AARCH64_CRYPTO_CRC32 = CPUINFO_FEATURE_ARM_CRYPTO_CRC32,
  CPUINFO_FEATURE_AARCH64_FP = (CPUINFO_FEATURE_AARCH64|(CPUINFO_FEATURE_ARM_CRYPTO&CPUINFO_FEATURE_MASK))+1,
